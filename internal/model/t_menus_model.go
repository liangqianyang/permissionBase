...
type Menus struct {
	...
	Url        string    `gorm:"column:url;type:varchar(128);not null;default:''" json:"url"`                                                       // 菜单url
	...
	OperatorId int64     `gorm:"column:operator_id;type:bigint;not null;default:0" json:"operator_id"`                                              // 操作人id
	Operator   string    `gorm:"column:operator;type:varchar(32);not null;default:''" json:"operator"`                                              // 操作人
